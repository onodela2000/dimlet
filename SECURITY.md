# Reporting a security issue / 脆弱性の報告

Please report suspected vulnerabilities in Dimlet privately to **info@osakanasoft.com** (Osakana Soft LLC / 合同会社おさかなソフト).
...
通常の不具合・機能要望はGitHub Issuesへ。ログやスクリーンショットから、シリアル番号などの非公開情報を削除して投稿してください。
