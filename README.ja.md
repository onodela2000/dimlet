...
1. [Releases](https://github.com/onodela2000/dimlet/releases/latest)から`Dimlet-0.1.0-macos-universal.zip`をダウンロード。
...
メニューはmacOSの言語に合わせて日本語／英語で表示します。ON中は画面の自動スリープも防ぎ、モニターとの接続を維持します。バックグラウンド作業が終わったら、メニューから**「Dimletを終了」**するとスリープ防止も解除されます。
