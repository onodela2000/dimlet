...
Dimlet is developed and provided by **[Osakana Soft LLC / 合同会社おさかなソフト](https://osakanasoft.com/)**.

- The app has no accounts, ads, analytics, or automatic network requests. Display information is used locally; screen contents are not captured. Language and mode preferences stay on your Mac.
...
Dimletの開発・提供元は合同会社おさかなソフトです。アプリに利用状況の計測・広告・自動通信はなく、画面の内容は撮影しません。言語やモードの設定はMac内に保存します。
